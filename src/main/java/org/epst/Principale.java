...
public class Principale {
    ...
    public String get() {
        String result = "" +
                ...
                "    <title>Politique de Confidentialité pour EPST-APP</title>\n" +
                "</head>\n" +
                "<body>\n" +
                "    <h1>Politique de Confidentialité pour EPST-APP</h1>\n" +
                "    \n" +
                "    <h2>1. Introduction</h2>\n" +
                "    <p>\n" +
                "        Bienvenue sur EPST-APP, une application développée pour offrir des services éducatifs et administratifs en République Démocratique du Congo (RDC). \n" +
                "        La présente politique de confidentialité explique comment nous collectons, utilisons, et protégeons vos données personnelles dans le cadre de votre \n" +
                "        utilisation de l'application.\n" +
                "    </p>\n" +
                "\n" +
                "    <h2>2. Données collectées</h2>\n" +
                "    <p>En utilisant EPST-APP, nous pouvons collecter les types de données suivants :</p>\n" +
                "    <ul>\n" +
                ...
                "    </ul>\n" +
                "    <p>Pour exercer ces droits, contactez-nous à l’adresse : <strong>contact@epst-app.cd</strong>.</p>\n" +
                "\n" +
                ...
                "    <p>\n" +
                "        <strong>Email :</strong> sgc@eduquepsp.education<br>\n" +
                "        <strong>Téléphone :</strong> (+243) 840018006<br>\n" +
                "        <strong>Adresse :</strong> 02, Avenue des Ambassadeurs, Kinshasa-Gombe, B.P: 3163 KIN 1, RD Congo\n" +
                "    </p>\n" +
                "</body>\n" +
                "</html>\n";
        return result;
